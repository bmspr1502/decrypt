...
<p id="result"></p>
<div class = "container">
    <p class = "text-white bg-dark">1.Decrypt the following message 😉
...
<br>Classy experience</p><br>
    ...
    <p class = "text-white bg-dark">2.Decrypt the following message 😊
<br>12-5-1-18-14</p><br>
    <pre><?php echo $row['answer2'];?></pre><br>
    <div class = "text-white bg-dark">3.Decrypt the following message 😭
        <img src="images/3rd question img.png" alt="IMAGE"></div>
        </div><br>
    <pre><?php echo $row['answer3'];?></pre><br>
    <div class = "text-white bg-dark">4.Decrypt the following message 😎
<br>UM UZNKXY
<br>Hint:The number of the most valuable and the least valued thing in a million
        </div><br>
    <pre><?php echo $row['answer4'];?></pre><br>
    <p class = "text-white bg-dark">5.Decrypt: 67-72-2-38-92 🙄
<br>Hint:“No matter what he does, every person on earth plays a central role in the history of the world. And normally he doesn't know it.”</p><br>
    ...
    <p class = "text-white bg-dark">6.Decrypt the following message 😶
        <img src="images/6th question img1.png" alt="img">
        <br>key:
        <img src="images/6th question img2.png" alt="img"> </p><br>
    <pre><?php echo $row['answer6'];?></pre><br>
    <p class = "text-white bg-dark">7.>Decrypt the following message 😴
            <br>LRRENOAFM</p><br>
    <pre><?php echo $row['answer7'];?></pre><br>
    <p class = "text-white bg-dark">8.Attend this question after completing all other 7 questions:
